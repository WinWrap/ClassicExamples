...
#Region " Windows Form Designer generated code "
    ...
    <System.Diagnostics.DebuggerStepThrough()> Private Sub InitializeComponent()
        ...
        Me.BasicIdeCtl1.HighlightBreak = System.Drawing.Color.DarkRed
        Me.BasicIdeCtl1.HighlightBuiltin = System.Drawing.Color.DarkCyan
        Me.BasicIdeCtl1.HighlightComment = System.Drawing.Color.DarkGreen
        Me.BasicIdeCtl1.HighlightError = System.Drawing.Color.Red
        Me.BasicIdeCtl1.HighlightExec = System.Drawing.Color.Yellow
        ...
        Me.Name = "Form1"
        Me.Text = "VB BasicIdeCtl - WatchDog"
...
#End Region
    ...
    Private Sub Form1_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles MyBase.Load
        ...
        ' *** WatchDog: example
        BasicIdeCtl1.AddExtension("WatchDog.", New WatchDog(BasicIdeCtl1))
        ' ***
        ...
        For i = 0 To files.Length - 1
            files(i) = GetSetting("idectl", "WatchDog", "FileMRU" & i + 1)
        Next i
    ...
    Private Sub BasicIdeCtl1_Disconnecting(ByVal sender As Object, ByVal e As System.EventArgs) Handles BasicIdeCtl1.Disconnecting
        ...
        Dim i As Integer
        For i = 0 To files.Length - 1
            SaveSetting("idectl", "WatchDog", "FileMRU" & i + 1, files(i))
        Next i
        ' ***
    End Sub

    Private Sub BasicNoUIObj_Pending(ByVal sender As Object, ByVal e As System.EventArgs) Handles BasicIdeCtl1.Pending
        ' *** WatchDog: example
