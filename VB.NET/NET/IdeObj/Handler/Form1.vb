...
#Region " Windows Form Designer generated code "
    ...
    Friend WithEvents BasicIdeObj1 As WinWrap.Basic.BasicIdeObj
    ...
    Friend WithEvents miViewBasicIde As System.Windows.Forms.MenuItem
    ...
    Friend WithEvents miRunAppHandler As System.Windows.Forms.MenuItem
    <System.Diagnostics.DebuggerStepThrough()> Private Sub InitializeComponent()
        Me.components = New System.ComponentModel.Container
        Me.BasicIdeObj1 = New WinWrap.Basic.BasicIdeObj(Me.components)
        Me.MainMenu1 = New System.Windows.Forms.MainMenu
        Me.miFile = New System.Windows.Forms.MenuItem
        Me.miFileExit = New System.Windows.Forms.MenuItem
        Me.MenuItem1 = New System.Windows.Forms.MenuItem
        Me.miViewBasicIde = New System.Windows.Forms.MenuItem
        ...
        Me.miRunAppHandler = New System.Windows.Forms.MenuItem
        Me.SuspendLayout()
        '
        'BasicIdeObj1
        '
        Me.BasicIdeObj1.BackColor = System.Drawing.SystemColors.Window
        Me.BasicIdeObj1.ForeColor = System.Drawing.SystemColors.WindowText
        Me.BasicIdeObj1.SelBackColor = System.Drawing.SystemColors.Highlight
        Me.BasicIdeObj1.SelForeColor = System.Drawing.SystemColors.HighlightText
        '
        'MainMenu1
        '
        Me.MainMenu1.MenuItems.AddRange(New System.Windows.Forms.MenuItem() {Me.miFile, Me.MenuItem1, Me.miTest, Me.miTrace})
        '
        'miFile
        '
        Me.miFile.Index = 0
        ...
        Me.MenuItem1.MenuItems.AddRange(New System.Windows.Forms.MenuItem() {Me.miViewBasicIde})
        Me.MenuItem1.Text = "&View"
        '
        'miViewBasicIde
        '
        Me.miViewBasicIde.Index = 0
        Me.miViewBasicIde.Text = "&Basic IDE"
        '
        'miTest
        '
        Me.miTest.Index = 2
        Me.miTest.MenuItems.AddRange(New System.Windows.Forms.MenuItem() {Me.miRunAppHandler})
        Me.miTest.Text = "&Test"
        '
        'miTrace
        '
        ...
        'miRunAppHandler
        '
        Me.miRunAppHandler.Index = 0
        Me.miRunAppHandler.Text = "Run AppHandler.bas"
        '
        'Form1
        '
        ...
        Me.Name = "Form1"
        Me.Text = "VB BasicIdeObj (on a form) - Handler"
...
#End Region
    ...
    Private Sub Form1_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        ...
        ' *** AddBasic: optional
        ' turn on tracing
        BasicIdeObj1.Trace(TraceConstants.All And Not TraceConstants.QueryEvent)
        ' ***

        ' *** AddBasic: recommended
        ' manage the Basic object/control using this form
        BasicIdeObj1.AttachToForm(Me, ManageConstants.All)
        ' ***

        ' *** Handler: example
        Dim handler As Handler = BasicIdeObj1.CreateHandler("Sub AppHandlerChanged")
        apphandler = New AppHandler(handler)
        BasicIdeObj1.AddExtension("AppHandler.", apphandler)
        ' ***

        ' *** AddBasic: optional
        ' load the file's most recently used file list from the registry
        Dim files() As String = BasicIdeObj1.FileMRU
        Dim i As Integer
        For i = 0 To files.Length - 1
            files(i) = GetSetting("ideobj", "Handler", "FileMRU" & i + 1)
        Next i
    ...
    Private Sub BasicIdeObj1_CloseWindow(ByVal sender As Object, ByVal e As WinWrap.Basic.Classic.CloseWindowEventArgs) Handles BasicIdeObj1.CloseWindow
        ' *** AddBasic: required
        ' hide the Basic Ide Object instead of minimizing it
        e.MinimizeWindow = False
        BasicIdeObj1.Visible = False
        ' ***
    End Sub

    Private Sub BasicIdeObj1_DebugTrace(ByVal sender As Object, ByVal e As WinWrap.Basic.Classic.TextEventArgs) Handles BasicIdeObj1.DebugTrace
    ...
    Private Sub BasicIdeObj1_Disconnecting(ByVal sender As Object, ByVal e As System.EventArgs) Handles BasicIdeObj1.Disconnecting
        ' *** AddBasic: optional
        ' save the file menu's most recently used file list in the registry
        Dim files() As String = BasicIdeObj1.FileMRU
        Dim i As Integer
        For i = 0 To files.Length - 1
            SaveSetting("ideobj", "Handler", "FileMRU" & i + 1, files(i))
        Next i
        ' ***
    End Sub
    ...
    Private Sub miViewBasicIde_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles miViewBasicIde.Click
        ' *** AddBasic: optional
        BasicIdeObj1.CreateOverlappedWindow()
        BasicIdeObj1.ActivateWindow()
        ' ***
    End Sub

    Private Sub miRunAppHandler_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles miRunAppHandler.Click
        ' *** Handler: test
        BasicIdeObj1.RunFile("""" & Application.ExecutablePath() & "\..\..\apphandler.bas""")
        ' ***
    End Sub
