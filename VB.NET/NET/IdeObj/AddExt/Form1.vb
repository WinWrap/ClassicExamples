...
Public Class Form1
    ...
    ' *** AddExt: example
    Private appobject As appobject = New appobject
    ' ***
...
#Region " Windows Form Designer generated code "
    ...
    Friend WithEvents miTestRunAppObject As System.Windows.Forms.MenuItem
    <System.Diagnostics.DebuggerStepThrough()> Private Sub InitializeComponent()
        ...
        Me.miTestRunAppObject = New System.Windows.Forms.MenuItem
        Me.SuspendLayout()
        '
        'BasicIdeObj1
        '
        ...
        '
        Me.miTest.Index = 2
        Me.miTest.MenuItems.AddRange(New System.Windows.Forms.MenuItem() {Me.miTestRunAppObject})
        Me.miTest.Text = "&Test"
        '
        'miTrace
        '
        ...
        'miTestRunAppObject
        '
        Me.miTestRunAppObject.Index = 0
        Me.miTestRunAppObject.Text = "Run AppObject.bas"
        '
        'Form1
        '
        ...
        Me.Name = "Form1"
        Me.Text = "VB BasicIdeObj (on a form) - AddExt"
...
#End Region
    ...
    Private Sub Form1_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        ...
        ' *** AddExt: example
        BasicIdeObj1.AddExtension(".AppObject.", appobject)
        ' ***
        ...
        For i = 0 To files.Length - 1
            files(i) = GetSetting("ideobj", "AddExt", "FileMRU" & i + 1)
        Next i
    ...
    Private Sub BasicIdeObj1_Disconnecting(ByVal sender As Object, ByVal e As System.EventArgs) Handles BasicIdeObj1.Disconnecting
        ...
        Dim i As Integer
        For i = 0 To files.Length - 1
            SaveSetting("ideobj", "AddExt", "FileMRU" & i + 1, files(i))
        Next i
        ' ***
    End Sub
    ...
    Private Sub miTestRunAppObject_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles miTestRunAppObject.Click
        ' *** AddExt: test
        BasicIdeObj1.RunFile("""" & Application.ExecutablePath() & "\..\..\appobject.bas""")
        ' ***
    End Sub
