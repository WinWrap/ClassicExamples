...
#Region " Windows Form Designer generated code "
    ...
    Friend WithEvents miFileNewBasicForm As System.Windows.Forms.MenuItem
    Friend WithEvents miFileSep1 As System.Windows.Forms.MenuItem
    ...
    <System.Diagnostics.DebuggerStepThrough()> Private Sub InitializeComponent()
        ...
        Me.miFileNewBasicForm = New System.Windows.Forms.MenuItem
        Me.miFileSep1 = New System.Windows.Forms.MenuItem
        ...
        '
        Me.miFile.Index = 0
        Me.miFile.MenuItems.AddRange(New System.Windows.Forms.MenuItem() {Me.miFileNewBasicForm, Me.miFileSep1, Me.miFileRun, Me.miFileSep2, Me.miFileExit})
        Me.miFile.Text = "&File"
        '
        'miFileNewBasicForm
        '
        Me.miFileNewBasicForm.Index = 0
        Me.miFileNewBasicForm.Text = "&New Basic Form"
        '
        'miFileSep1
        '
        Me.miFileSep1.Index = 1
        Me.miFileSep1.Text = "-"
        '
        'miFileRun
        '
        Me.miFileRun.Index = 2
        Me.miFileRun.Text = "&Run test1.bas"
        '
        'miFileSep2
        '
        Me.miFileSep2.Index = 3
        Me.miFileSep2.Text = "-"
        '
        'miFileExit
        '
        Me.miFileExit.Index = 4
...
#End Region
    ...
    Private Sub miFileNewBasicForm_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles miFileNewBasicForm.Click
        ' *** Threads: example
        BasicForm.Spawn(basicthreadcollection_, Nothing)
        ' ***
    End Sub
