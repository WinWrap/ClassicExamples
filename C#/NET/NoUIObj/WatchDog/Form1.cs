...
namespace samp
{
	...
	public class Form1 : System.Windows.Forms.Form
	{
		...
		private System.Windows.Forms.MenuItem miTestRunTimeout;
		private System.Windows.Forms.MenuItem miTestRunTimeout2;
		private System.Windows.Forms.MenuItem miTestRunTimeout3;
		...
		public Form1()
		{
			...
			this.basicNoUIObj.Pending += new System.EventHandler<System.EventArgs>(basicNoUIObj_Pending);
			// ***
		}
		...
		private void InitializeComponent()
		{
			...
			this.miTestRunTimeout = new System.Windows.Forms.MenuItem();
			this.miTestRunTimeout2 = new System.Windows.Forms.MenuItem();
			this.miTestRunTimeout3 = new System.Windows.Forms.MenuItem();
			...
			this.miTest.MenuItems.AddRange(new System.Windows.Forms.MenuItem[] {
																				   this.miTestRunTimeout,
																				   this.miTestRunTimeout2,
																				   this.miTestRunTimeout3});
			this.miTest.Text = "&Test";
			// 
			// miTestRunTimeout
			// 
			this.miTestRunTimeout.Index = 0;
			this.miTestRunTimeout.Text = "Run Timeout.bas";
			this.miTestRunTimeout.Click += new System.EventHandler(this.miTestRunTimeout_Click);
			// 
			// miTestRunTimeout2
			// 
			this.miTestRunTimeout2.Index = 1;
			this.miTestRunTimeout2.Text = "Run Timeout2.bas";
			this.miTestRunTimeout2.Click += new System.EventHandler(this.miTestRunTimeout2_Click);
			// 
			// miTestRunTimeout3
			// 
			this.miTestRunTimeout3.Index = 2;
			this.miTestRunTimeout3.Text = "Run Timeout3.bas";
			this.miTestRunTimeout3.Click += new System.EventHandler(this.miTestRunTimeout3_Click);
			// 
			// miTrace
			// 
			...
			this.Name = "Form1";
			this.Text = "C# BasicNoUIObj (NOT on a form) - WatchDog";
		...
		private void Form1_Load(object sender, System.EventArgs e)
		{
			...
			// *** WatchDog: example
			basicNoUIObj.AddExtension(".WatchDog.", new WatchDog(basicNoUIObj));
			// ***
		}

		private void basicNoUIObj_DebugTrace(object sender, TextEventArgs e)
		{
		...
		private void basicNoUIObj_Pending(object sender, EventArgs e)
		{
			// *** WatchDog: example
		...
		private void miTestRunTimeout_Click(object sender, System.EventArgs e)
		{
			// *** WatchDog: test
			basicNoUIObj.RunFile("\"" + Application.ExecutablePath + "\\..\\..\\..\\timeout.bas\"");
			// ***
		}

		private void miTestRunTimeout2_Click(object sender, System.EventArgs e)
		{
			// *** WatchDog: test
			basicNoUIObj.RunFile("\"" + Application.ExecutablePath + "\\..\\..\\..\\timeout2.bas\"");
			// ***
		}

		private void miTestRunTimeout3_Click(object sender, System.EventArgs e)
		{
			// *** WatchDog: test
			basicNoUIObj.RunFile("\"" + Application.ExecutablePath + "\\..\\..\\..\\timeout3.bas\"");
			// ***
		}
