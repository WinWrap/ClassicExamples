...
#Region " Windows Form Designer generated code "
    ...
    Friend WithEvents miTestRunAppHandler As System.Windows.Forms.MenuItem
    <System.Diagnostics.DebuggerStepThrough()> Private Sub InitializeComponent()
        ...
        Me.miTestRunAppHandler = New System.Windows.Forms.MenuItem
        Me.SuspendLayout()
        '
        'MainMenu1
        '
        ...
        '
        Me.miTest.Index = 2
        Me.miTest.MenuItems.AddRange(New System.Windows.Forms.MenuItem() {Me.miTestRunAppHandler})
        Me.miTest.Text = "&Test"
        '
        'miTrace
        '
        ...
        'miTestRunAppHandler
        '
        Me.miTestRunAppHandler.Index = 0
        Me.miTestRunAppHandler.Text = "Run AppHandler.bas"
        '
        'Form1
        '
        ...
        Me.Name = "Form1"
        Me.Text = "VB BasicIdeObj (NOT on a form) - Handler"
...
#End Region
    ...
    Private Sub Form1_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        ...
        ' *** Handler: example
        Dim handler As Handler = BasicIdeObj.CreateHandler("Sub AppHandlerChanged")
        apphandler = New AppHandler(handler)
        BasicIdeObj.AddExtension("AppHandler.", apphandler)
        ' ***
        ...
        For i = 0 To files.Length - 1
            files(i) = GetSetting("ideobj2", "Handler", "FileMRU" & i + 1)
        Next i
        BasicIdeObj.FileMRU = files
        ' ***

        ' *** AddBasic: optional
        BasicIdeObj.FileDir = Application.ExecutablePath & "\..\.."
        ' ***
    End Sub
    ...
    Private Sub BasicIdeObj_Disconnecting(ByVal sender As Object, ByVal e As System.EventArgs) Handles BasicIdeObj.Disconnecting
        ...
        Dim i As Integer
        For i = 0 To files.Length - 1
            SaveSetting("ideobj2", "Handler", "FileMRU" & i + 1, files(i))
        Next i
        ' ***
    End Sub
    ...
    Private Sub miTestRunAppHandler_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles miTestRunAppHandler.Click
        ' *** Handler: test
        BasicIdeObj.RunFile("""" & Application.ExecutablePath() & "\..\..\apphandler.bas""")
        ' ***
    End Sub
