...
Public Class Form1
    ...
    ' *** AddBasic: required
    Friend WithEvents BasicIdeObj As BasicIdeObj = New BasicIdeObj
    ' ***
...
#Region " Windows Form Designer generated code "
    ...
    Friend WithEvents miTestRunTimeout As System.Windows.Forms.MenuItem
    Friend WithEvents miTestRunTimeout2 As System.Windows.Forms.MenuItem
    Friend WithEvents miTestRunTimeout3 As System.Windows.Forms.MenuItem
    <System.Diagnostics.DebuggerStepThrough()> Private Sub InitializeComponent()
        ...
        Me.miTestRunTimeout = New System.Windows.Forms.MenuItem
        Me.miTestRunTimeout2 = New System.Windows.Forms.MenuItem
        Me.miTestRunTimeout3 = New System.Windows.Forms.MenuItem
        ...
        '
        Me.miTest.Index = 1
        Me.miTest.MenuItems.AddRange(New System.Windows.Forms.MenuItem() {Me.miTestRunTimeout, Me.miTestRunTimeout2, Me.miTestRunTimeout3})
        Me.miTest.Text = "&Test"
        '
        'miTestRunTimeout
        '
        Me.miTestRunTimeout.Index = 0
        Me.miTestRunTimeout.Text = "Run Timeout.bas"
        '
        'miTestRunTimeout2
        '
        Me.miTestRunTimeout2.Index = 1
        Me.miTestRunTimeout2.Text = "Run Timeout2.bas"
        '
        'miTestRunTimeout3
        '
        Me.miTestRunTimeout3.Index = 2
        Me.miTestRunTimeout3.Text = "Run Timeout3.bas"
        '
        'miTrace
        '
        Me.miTrace.Index = 2
        ...
        Me.Name = "Form1"
        Me.Text = "VB BasicIdeObj (NOT on a form) - WatchDog"
...
#End Region
    ...
    Private Sub Form1_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        ...
        ' *** WatchDog: example
        BasicIdeObj.AddExtension(".WatchDog.", New WatchDog(BasicIdeObj))
        ' ***

        ' *** AddBasic: recommended
        ' manage the Basic object/control using this form
        BasicIdeObj.AttachToForm(Me, ManageConstants.All)
        ' ***
    End Sub
    ...
    Private Sub BasicIdeObj_Pending(ByVal sender As Object, ByVal e As System.EventArgs) Handles BasicIdeObj.Pending
        ' *** WatchDog: example
    ...
    Private Sub miTestRunTimeout_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles miTestRunTimeout.Click
        ' *** WatchDog: test
        BasicIdeObj.RunFile("""" & Application.ExecutablePath() & "\..\..\timeout.bas""")
        ' ***
    End Sub

    Private Sub miTestRunTimeout2_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles miTestRunTimeout2.Click
        ' *** WatchDog: test
        BasicIdeObj.RunFile("""" & Application.ExecutablePath() & "\..\..\timeout2.bas""")
        ' ***
    End Sub

    Private Sub miTestRunTimeout3_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles miTestRunTimeout3.Click
        ' *** WatchDog: test
        BasicIdeObj.RunFile("""" & Application.ExecutablePath() & "\..\..\timeout3.bas""")
        ' force language extension to return prematurely
        ' ***
    End Sub
