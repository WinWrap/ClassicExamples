...
#Region " Windows Form Designer generated code "
    ...
    <System.Diagnostics.DebuggerStepThrough()> Private Sub InitializeComponent()
        ...
        Me.Name = "Form1"
        Me.Text = "VB BasicIdeObj (on a form) - AddEvent"
...
#End Region
    ...
    Private Sub Form1_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        ...
        ' *** AddEvent: example
        BasicIdeObj1.AddExtensionWithEvents(".AppObject", appobject)
        ' ***
        ...
        For i = 0 To files.Length - 1
            files(i) = GetSetting("ideobj", "AddEvent", "FileMRU" & i + 1)
        Next i
    ...
    Private Sub BasicIdeObj1_Disconnecting(ByVal sender As Object, ByVal e As System.EventArgs) Handles BasicIdeObj1.Disconnecting
        ...
        Dim i As Integer
        For i = 0 To files.Length - 1
            SaveSetting("ideobj", "AddEvent", "FileMRU" & i + 1, files(i))
        Next i
        ' ***
    End Sub
