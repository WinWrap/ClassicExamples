...
#Region " Windows Form Designer generated code "
    ...
    <System.Diagnostics.DebuggerStepThrough()> Private Sub InitializeComponent()
        ...
        Me.Name = "Form1"
        Me.Text = "VB BasicNoUIObj (on a form) - Handler"
...
#End Region
    ...
    Private Sub Form1_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        ...
        ' *** Handler: example
        Dim handler As Handler = BasicNoUIObj1.CreateHandler("Sub AppHandlerChanged")
        apphandler = New AppHandler(handler)
        BasicNoUIObj1.AddExtension("AppHandler.", apphandler)
        ' ***
    End Sub

    Private Sub BasicNoUIObj1_DebugTrace(ByVal sender As Object, ByVal e As WinWrap.Basic.Classic.TextEventArgs) Handles BasicNoUIObj1.DebugTrace
    ...
    Private Sub miTestRunAppHandler_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles miTestRunAppHandler.Click
        ' *** Handler: test
        BasicNoUIObj1.RunFile("""" & Application.ExecutablePath() & "\..\..\apphandler.bas""")
        ' ***
    End Sub
    ...
    Private Sub TraceToggle(ByVal sender As System.Object)
        ...
        For i = 0 To 5
            ...
            End If
        Next
        BasicNoUIObj1.Trace(categories)
        ' ***
    End Sub
    ...
    Private Sub miTraceNone_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles miTraceNone.Click
        ...
        BasicNoUIObj1.Trace(TraceConstants.None)
        ' ***
    End Sub
    ...
    Private Sub miTraceAll_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles miTraceAll.Click
        ...
        BasicNoUIObj1.Trace(TraceConstants.All)
        ' ***
    End Sub
