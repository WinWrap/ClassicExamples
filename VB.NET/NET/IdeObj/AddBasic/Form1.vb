...
#Region " Windows Form Designer generated code "
    ...
    Friend WithEvents miTestRunToError As System.Windows.Forms.MenuItem
    ...
    <System.Diagnostics.DebuggerStepThrough()> Private Sub InitializeComponent()
        ...
        Me.miTestRunToError = New System.Windows.Forms.MenuItem
        ...
        '
        Me.miTest.Index = 2
        Me.miTest.MenuItems.AddRange(New System.Windows.Forms.MenuItem() {Me.miTestRunMsgBox, Me.miTestRunWait, Me.MenuItem2, Me.miTestRunToError})
        Me.miTest.Text = "&Test"
        '
        'miTestRunMsgBox
        '
        ...
        'miTestRunToError
        '
        Me.miTestRunToError.Index = 3
        Me.miTestRunToError.Text = "Run to Error"
        '
        'miTrace
        '
        Me.miTrace.Index = 3
        ...
        Me.Name = "Form1"
        Me.Text = "VB BasicIdeObj (on a form) - AddBasic"
...
#End Region
    ...
    Private Sub miTestRunToError_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles miTestRunToError.Click
        ' *** AddBasic: test
        BasicIdeObj1.RunThis("Error 1")
        ' ***
    End Sub
