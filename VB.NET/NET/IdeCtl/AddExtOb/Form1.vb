...
#Region " Windows Form Designer generated code "
    ...
    <System.Diagnostics.DebuggerStepThrough()> Private Sub InitializeComponent()
        ...
        Me.Name = "Form1"
        Me.Text = "VB BasicIdeCtl - AddExtOb"
...
#End Region
    ...
    Private Sub Form1_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles MyBase.Load
        ...
        BasicIdeCtl1.AddExtensionObject("AppObject", appobject)
        ' ***
        ...
        For i = 0 To files.Length - 1
            files(i) = GetSetting("idectl", "AddExtOb", "FileMRU" & i + 1)
        Next i
    ...
    Private Sub BasicIdeCtl1_Disconnecting(ByVal sender As Object, ByVal e As System.EventArgs) Handles BasicIdeCtl1.Disconnecting
        ...
        Dim i As Integer
        For i = 0 To files.Length - 1
            SaveSetting("idectl", "AddExtOb", "FileMRU" & i + 1, files(i))
        Next i
        ' ***
    End Sub
