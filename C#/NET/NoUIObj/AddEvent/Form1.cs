...
namespace samp
{
	...
	public class Form1 : System.Windows.Forms.Form
	{
		...
		private System.Windows.Forms.MenuItem miTestAppObject;
		...
		private void InitializeComponent()
		{
			...
			this.miTestAppObject = new System.Windows.Forms.MenuItem();
			...
			this.miTest.MenuItems.AddRange(new System.Windows.Forms.MenuItem[] {
																				   this.miTestAppObject});
			this.miTest.Text = "&Test";
			// 
			// miTestAppObject
			// 
			this.miTestAppObject.Index = 0;
			this.miTestAppObject.Text = "Run AppObject.bas";
			this.miTestAppObject.Click += new System.EventHandler(this.miTestRunAppObject_Click);
			// 
			// miTrace
			// 
			...
			this.Name = "Form1";
			this.Text = "C# BasicNoUIObj (NOT on a form) - AddEvent";
		...
		private void Form1_Load(object sender, System.EventArgs e)
		{
			...
			// *** AddEvent: example
			basicNoUIObj.AddExtensionWithEvents(".AppObject", appobject);
			// ***
		}
