...
namespace samp
{
	...
	public class Form1 : System.Windows.Forms.Form
	{
		...
		private System.Windows.Forms.MenuItem miTestRunAppHandler;
		...
		public Form1()
		{
			...
			this.basicNoUIObj.Disconnecting += new System.EventHandler<System.EventArgs>(basicNoUIObj_Disconnecting);
			// ***
		}
		...
		private void InitializeComponent()
		{
			...
			this.miTestRunAppHandler = new System.Windows.Forms.MenuItem();
			...
			this.miTest.MenuItems.AddRange(new System.Windows.Forms.MenuItem[] {
																				   this.miTestRunAppHandler});
			this.miTest.Text = "&Test";
			// 
			// miTestRunAppHandler
			// 
			this.miTestRunAppHandler.Index = 0;
			this.miTestRunAppHandler.Text = "Run AppHandler.bas";
			this.miTestRunAppHandler.Click += new System.EventHandler(this.miTestRunAppHandler_Click);
			// 
			// miTrace
			// 
			...
			this.Name = "Form1";
			this.Text = "C# BasicNoUIObj (NOT on a form) - Handler";
		...
		private void miTestRunAppHandler_Click(object sender, System.EventArgs e)
		{
			// *** Handler: test
			basicNoUIObj.RunFile("\"" + Application.ExecutablePath + "\\..\\..\\..\\apphandler.bas\"");
			// ***
		}
