...
#Region " Windows Form Designer generated code "
    ...
    <System.Diagnostics.DebuggerStepThrough()> Private Sub InitializeComponent()
        ...
        Me.Name = "Form1"
        Me.Text = "VB BasicIdeObj (NOT on a form) - AddBasic"
...
#End Region
    ...
    Private Sub Form1_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        ...
        For i = 0 To files.Length - 1
            files(i) = GetSetting("ideobj2", "AddBasic", "FileMRU" & i + 1)
        Next i
    ...
    Private Sub BasicIdeObj_Disconnecting(ByVal sender As Object, ByVal e As System.EventArgs) Handles BasicIdeObj.Disconnecting
        ...
        Dim i As Integer
        For i = 0 To files.Length - 1
            SaveSetting("ideobj2", "AddBasic", "FileMRU" & i + 1, files(i))
        Next i
        ' ***
    End Sub
    ...
    Private Sub miTestRunMsgBox_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles miTestRunMsgBox.Click
        ' *** AddBasic: test
        BasicIdeObj.RunFile("""" & Application.ExecutablePath() & "\..\..\msgbox.bas""")
        ' ***
    End Sub

    Private Sub miTestRunWait_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles miTestRunWait.Click
        ' *** AddBasic: test
        BasicIdeObj.RunFile("""" & Application.ExecutablePath() & "\..\..\wait.bas""")
        ' ***
    End Sub
