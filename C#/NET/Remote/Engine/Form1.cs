...
namespace samp
{
	...
	{
		private WinWrap.Basic.BasicNoUIObj basicNoUIObj1;
		...
		private void InitializeComponent()
		{
			...
			this.basicNoUIObj1 = new WinWrap.Basic.BasicNoUIObj(this.components);
			...
			// basicNoUIObj1
			// 
            this.basicNoUIObj1.Pause_ += new System.EventHandler<System.EventArgs>(this.basicNoUIObj1_Pause_);
            this.basicNoUIObj1.End += new System.EventHandler<System.EventArgs>(this.basicNoUIObj1_End);
            this.basicNoUIObj1.Resume += new System.EventHandler<System.EventArgs>(this.basicNoUIObj1_Resume);
            this.basicNoUIObj1.Synchronizing += new System.EventHandler<WinWrap.Basic.Classic.SynchronizingEventArgs>(this.basicNoUIObj1_Synchronizing);
            this.basicNoUIObj1.DebugPrint += new System.EventHandler<WinWrap.Basic.Classic.TextEventArgs>(this.basicNoUIObj1_DebugPrint);
            this.basicNoUIObj1.Begin += new System.EventHandler<System.EventArgs>(this.basicNoUIObj1_Begin);
			// 
			// mainMenu1
			// 
			...
			this.Name = "Form1";
			this.Text = "C# BasicNoUIObj (on a form) - Remote";
		...
		private void Form1_Load(object sender, System.EventArgs e)
		{
            ...
            // *** AddBasic: optional
			// turn on tracing
			basicNoUIObj1.Trace(TraceConstants.All&~TraceConstants.QueryEvent);
			// ***

			// *** AddBasic: recommended
			// manage the Basic object/control using this form
			basicNoUIObj1.AttachToForm(this, ManageConstants.All);
			// ***
		...
		private void basicNoUIObj1_DebugPrint(object sender, WinWrap.Basic.Classic.TextEventArgs e)
		{
			lblInfo.Text = e.Text;
		}

		private void basicNoUIObj1_Begin(object sender, System.EventArgs e)
		{
		...
		private void basicNoUIObj1_End(object sender, System.EventArgs e)
		{
			lblInfo.Text = "Idle.";
			btnRun.Enabled = true;
		...
		private void basicNoUIObj1_Pause_(object sender, System.EventArgs e)
		{
			lblInfo.Text = "Paused.";
			btnRun.Enabled = true;
			btnPause.Enabled = false;
		...
		private void basicNoUIObj1_Resume(object sender, System.EventArgs e)
		{
		...
		private void basicNoUIObj1_Synchronizing(object sender, WinWrap.Basic.Classic.SynchronizingEventArgs e)
		{
