...
#Region " Windows Form Designer generated code "
    ...
    Friend WithEvents miRunAppObject As System.Windows.Forms.MenuItem
    <System.Diagnostics.DebuggerStepThrough()> Private Sub InitializeComponent()
        ...
        Me.miRunAppObject = New System.Windows.Forms.MenuItem
        ...
        '
        Me.miTest.Index = 1
        Me.miTest.MenuItems.AddRange(New System.Windows.Forms.MenuItem() {Me.miRunAppObject})
        Me.miTest.Text = "&Test"
        '
        'miRunAppObject
        '
        Me.miRunAppObject.Index = 0
        Me.miRunAppObject.Text = "Run AppObject.bas"
        '
        'miTrace
        '
        Me.miTrace.Index = 2
        ...
        Me.Name = "Form1"
        Me.Text = "VB BasicNoUIObj (on a form) - AddExt"
...
#End Region
    ...
    Private Sub Form1_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        ...
        ' *** AddExt: example
        BasicNoUIObj1.AddExtension(".AppObject.", AppObject)
        ' ***
    End Sub
    ...
    Private Sub miRunAppObject_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles miRunAppObject.Click
        ' *** AddExt: test
        BasicNoUIObj1.RunFile("""" & Application.ExecutablePath() & "\..\..\appobject.bas""")
        ' ***
    End Sub
