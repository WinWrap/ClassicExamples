...
namespace samp
{
	...
	public class Form1 : System.Windows.Forms.Form
	{
		...
		private void InitializeComponent()
		{
			...
			this.basicIdeCtl1.Pending += new System.EventHandler<System.EventArgs>(this.basicIdeCtl1_Pending);
			...
			this.Name = "Form1";
			this.Text = "C# BasicIdeCtl - WatchDog";
		...
		private void Form1_Load(object sender, System.EventArgs e)
		{
			...
			// *** WatchDog: example
			basicIdeCtl1.AddExtension(".WatchDog.", new WatchDog(basicIdeCtl1 as IBasicNoUI));
			// ***

			// *** AddBasic: optional
			// load the file's most recently used file list from the registry
			string[] files = basicIdeCtl1.FileMRU;
			using (RegistryKey rk = Registry.CurrentUser.CreateSubKey(@"Software\Polar Engineering\C#\IdeCtl\WatchDog"))
